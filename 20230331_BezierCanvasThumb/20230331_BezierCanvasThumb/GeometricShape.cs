...
{
    public enum ShapeType { Bezier = 0, Line }
    ...
    public class GeometricShape : Shape
    {
        ...
        public static readonly DependencyProperty MyPropertyProperty =
            DependencyProperty.Register(nameof(MyProperty), typeof(int), typeof(GeometricShape),
        ...
        private void Bezier_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            MyAdorner.SetBinding(MyAdorner.MyAnchorThumbSizeProperty, new Binding() { Source = this, Path = new PropertyPath(GeometricShape.MyAnchorThumbSizeProperty) });
